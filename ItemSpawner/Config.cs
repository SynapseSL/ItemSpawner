...
namespace ItemSpawner
{
    public class Config : AbstractConfigSection
    {
        ...
        {
            new ItemSpawn {Item = new SerializedItem((int)ItemType.KeycardO5, 0, 0, Vector3.one),Position = new SerializedMapPoint("HCZ_079", 5.290604f, -3, -6.44455f),SpawnChance = 100f},
        };
    }
